    ...
    <RadioGroup {...props}>
      {data.map(({ icon: Icon, ...item }) => (
        <FormItem
          ...
          className={cn(
            "dark:bg-input/30 border-input shadow-xs has-data-[state=checked]:border-[var(--radio-color)] relative items-start rounded-md border p-4",
        ...
        >
          <div
            className={cn(
              "has-data-[state=checked]:[&>label]:text-[var(--radio-color)] flex w-full justify-between gap-x-2",
          ...
          >
            ...
            <FormControl>
              <RadioGroupItem
                value={item.value}
                className={cn(
                  "has-data-[state=checked]:border-[var(--radio-color)] after:absolute after:inset-0",
          ...
          {item.desc && (
            <span
              className={cn(
                "text-muted-foreground text-pretty text-xs",
